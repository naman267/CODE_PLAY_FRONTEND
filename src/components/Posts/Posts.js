...
class Posts extends Component {
  ...
  componentDidMount() {
    ...
    // fetch all posts
    axios
      .get('https://code-play-apis.onrender.com/getposts')
      .then((response) => {
  ...
  searchPosts = (searchText) => {
    axios
      .get(`https://code-play-apis.onrender.com/getposts/${searchText}`)
      .then((response) => {
  ...
  createNewPost = (event) => {
    ...
    axios
      .post('https://code-play-apis.onrender.com/makepost', newPostData, {
        headers: {
